...
class GenreController extends AbstractController
{
    ...
    {
        return $this->render('bookland/genre/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('bookland/genre/new.html.twig', [
            'genre' => $genre,
    ...
    {
        return $this->render('bookland/genre/show.html.twig', [
            'genre' => $genre,
    ...
    public function edit(Request $request, Genre $genre, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('bookland/genre/edit.html.twig', [
            'genre' => $genre,
            'form' => $form->createView()
    ...
    /**
     * @Route("/{id}", name="delete_genre", methods={"POST"})
     * @param $id
